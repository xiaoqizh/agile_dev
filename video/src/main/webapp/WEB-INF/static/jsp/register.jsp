...
<head>
	...
	<!-- <script>
		function getCode(phone) {
			$.ajax({
				url:"E:/%E5%AD%A6%E6%A0%A1%E7%9B%B8%E5%85%B3/web/web%E5%B7%A5%E7%A8%8B/zeroth_24_zFanVideo/zeroth_24_zFanVideo/contact.html",
				type:"post",
				dataType:"json",
				async:true,
				cache:false,
				data:document.getElementById(phone),
			...
			<div class="row">
				<div id="main-content" class="col-2-3">
					<div class="contact">
						<h2>注册</h2>
						<div id="contact_form">
							<form name="form1" id="ff" method="post" action="http://localhost:8088/register">
								<label>
									<span>用户名</span>
								...
								<label>
									<span>手机号</span>
									<input type="text" name="phone"  id="phone" required="required" placeholder="请输入手机号码">
									<input class="sendButton"  id="getCode" type="button" value="获取验证码">
									<span>验证码</span>
									<input type="text" id="code"   name="code"  required="required" placeholder="请输入验证码">
									...
									<%--<script type="text/javascript">--%>
                                        <%--$(function () {--%>
                                            ...
                                            <%--//发送验证码--%>
                                            <%--alert("monther fucker");--%>
                                            <%--$("#getCode").click(function () {--%>
                                                <%--$.ajax({--%>
                                                    <%--url: "http://localhost:8088/sms_verify?phone"+$("#phone").val(),--%>
                                                    <%--data: {--%>
                                                        <%--// "phone": $("#phone").val()--%>
                                                    <%--},--%>
                                                    <%--type: "post",--%>
								...
								<label float="right">
									<span style="float:inherit">
										<a href="http://localhost:8088/to_mail_register">用邮箱注册></a>
									</span>
								</label>
	...
	<script type="text/javascript">
        $(document).ready(function() {
            $(function () {
                ...
                $("#validate").click(function () {
                    $.ajax({
                        url: "http://localhost:8088/sms_2verify?code" + $("#code").val(),
                        data: {
                            "code": $("#code").val()
                        },
                        type: "post",
