...
<div class="wrap-body">
    ...
    <nav class="cmn-tile-nav">
		<ul class="clearfix">
			<li class="colour-1"><a href="http://localhost:8088/column?type=1">篮球</a></li>
...
" frameborder="0" allowfullscreen></iframe> -->
    ...
    <script>
        $(document).ready(function(){
            $(".sendButton").click(
                function(){
                    $.post("http://localhost:8088/comment",
                        {content:$(".ipt-txt").val(),
                            videoid:$('#video-id').val()},
                        function(data){
                            if ($(".ipt-txt").val()!="") {
	...
	<script type="text/javascript">
        $(document).ready(function(){
            $("#collection").click(function(){
                ...
                $.post("http://localhost:8088/collection",
                    {
                        <%--userid:${user.id},--%>
                        videoId: $("#video-id").val()},
                    function(){
