		...
		<div class="wrap-header">
			<div class="zerogrid">
				<div class="row">
					...
					<a href="http://localhost:8088/index" class="logo"><img src="../images/logosamll.jpg" system = "width :200px ; height : 100px;"/></a>
					<c:if test="${user ==null}">
						<ul class="social">
							<br />
								...
								<div class="wrap-col">
									<div class="wrap-vid">
										<div class="zoom-container">
											<%--   !!!!!!!!!!!!!!!--%>
											<%--<a href="http://localhost:8088/video?videoid">--%>
											<a href="http://localhost:8088/video?videoid=${singleVideo.id}">
